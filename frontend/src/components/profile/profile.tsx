...
export const Profile = () => {
  ...
  const postsHandler = async () => {
    const posts = await axios.get(
      `http://80.253.246.129:3000/post/getUserRelPost/`,
      {
        headers: {
          "x-access-token": auth().token,
        },
  ...
  const savedHandler = async () => {
    const saved = await axios.get(
      `http://80.253.246.129:3000/post/getSavedPost/`,
      {
        headers: {
          "x-access-token": auth().token,
        },
  ...
  const imagePostHandler = async () => {
    const imagePost = await axios.get(
      `http://80.253.246.129:3000/post/getUserRelImagePost/`,
      {
        headers: {
          "x-access-token": auth().token,
        },
            ...
            <div className="d-flex-justify-content-between mt-5 border-bottom border-top border-2 border-dark ">
              <ul className="d-flex justify-content-around lists">
                ...
                <li className="lists-item">
                  <span onClick={likedHandle} style={{ fontWeight: "bold" }}>
                    begeniler
                  </span>
                </li>
                <li
            ...
            {catTitle != "image" ? (
              ...
              posts.map((post: any, key: any) => (
                <section
                  ...
                  style={{ width: "46rem", marginLeft: "50px" }}
                  key={key}
                >
                  <div className="">
                    <div className="d-flex justify-content-between">
                    ...
                    <div className="post-block__content mb-2 text-start">
                        ...
                        {expanded ? (
                          ...
                          <>
                            {post[1].description.length > maxLength
                              ? post[1].description.slice(0, maxLength) +
                                " [ Devamını oku... ]"
                              : post[1].description}
                          </>
                        )}
                      ...
                      <div className="post-block__content mb-2 ms-3">
                        ...
                        >
                          <i id={post[1].id} className="fa-solid fa-heart"></i>
                        </p>
                        <p
              ...
              <div className="container">
                <div className="row">
                  ...
                  {posts &&
                    posts.map((post: any, key: any) => (
                      <>
                        <div key={key} className="pt-2 ps-1">
