...
export class UserService {
    ...
    userUpdate(id: string, nickname: string, email: string, date: string,oldPassword:string,newPassword:string,hash:string, gender: string, password: string) {
        const isValidId = validation.isIdValidation(id)
        ...
        if (isValidId.isValid) {
            if (isEmail.isEmail) {
                if (decrypt.isDencrypt) {
                    ...
                    return {
                        update: this.userDataAcess.update(id, nickname, email, date, gender,encrypt)
                    }
                }
                else {
                    return {
    ...
    async userCreate(nickname: string, email: string, date: string, gender: string, password: string) {
